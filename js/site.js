...
function renderFooter(){
  document.body.insertAdjacentHTML('beforeend',`
    <footer class="site-footer">
      ...
      <a class="footer-contact" href="como-usar.html"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 6.5c-1.8-1.2-4-1.7-6-1.5v12c2-.2 4.2.3 6 1.5 1.8-1.2 4-1.7 6-1.5v-12c-2-.2-4.2.3-6 1.5Z"/><path d="M12 6.5v12"/></svg>Como usar</a>
